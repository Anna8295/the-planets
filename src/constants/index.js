...
export const PlanetFacts = [
  {
    id: "MERCURY",
    facts: [
      { name: 'rotation', value: '58.6 Days'},
      { name: 'revolution', value: "87.97 Days" }, 
      { name: 'radius', value: "2,439.7 KM"},
      { name: 'temperature', value: "430°c" }
    ]
  },
  {
    id: "VENUS",
    facts:[
      { name: 'rotation', value: '243 Days'},
      { name: 'revolution', value: '224.7 Days'},
      { name: 'radius', value: '6,051.8 KM'},
      { name: 'temperature', value: '471°c'},
    ]
  },
  {
    id: "EARTH",
    facts:[
      { name: 'rotation', value: '0.99 Days' },
      { name: 'revolution', value: '365.26 Days' },
      { name: 'radius', value: '6,371 KM' },
      { name: 'temperature', value: '16°c' },
    ]
  },
  {
    id: "MARS",
    facts:[
      { name: 'rotation', value: '1.03 Days' },
      { name: 'revolution', value: '1.88 Years' },
  ...
  },
  {
    id: "JUPITER",
    facts: [
      { name: 'rotation', value: '9.93 Hours' },
      { name: 'revolution', value: '11.86 Years' },
      { name: 'radius', value: '69,911 KM' },
      { name: 'temperature', value: '-108°c' },
    ]
  },
  {
    id: "SATURN",
    facts:[
      { name: 'rotation', value: '10.8 Hours' },
      { name: 'revolution', value: '29.46 Years' },
      { name: 'radius', value: '58,232 KM' },
      { name: 'temperature', value: '-138°c' },
    ]
  },
  {
    id: "URANUS",
    facts:[
      { name: 'rotation', value: '17.2 Hours' },
      { name: 'revolution', value: '84 Years' },
      { name: 'radius', value: '25,362 KM' },
      { name: 'temperature', value: '-195°c' },
    ]
  },
  {
    id: "NEPTUNE",
    facts:[
      { name: 'rotation', value: '16.08 Hours' },
      { name: 'revolution', value: '164.79 Years' },
      { name: 'radius', value: '24,622 KM' },
      { name: 'temperature', value: '-201°c' },
    ]
  },
]
